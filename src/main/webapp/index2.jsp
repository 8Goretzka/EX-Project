    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDarkDropdown">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#">전시회 목록</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="loginForm.html">전시회 후기</a>
          </li>
        ...
        <a href="joinForm.jsp"><button type="button" class="btn btn-outline-success me-4">회원가입</button></a>
         <%
        	}
        	else{
       %>
